                ...
                <div class="col-md-12">
                    ...
                    <div class="portlet box red">
                        <div class="portlet-title">
                            <div class="caption">User's Feedback List</div>
                            <div class="actions">
                                <a class="btn danger-btn btn-sm" href="<?php echo config_item('admin_base_url');?>feedback/add"> Manage Feedback</a>
                            </div>
                        </div>
                        <div class="portlet-body">
                            <div class="table-container">
                            <?php 
                            if($this->session->flashdata('feedback_ques_msg_MSG'))
                            {?>
                                <div class="alert alert-success">
                                    <strong>Success!</strong> <?php echo $this->session->flashdata('feedback_ques_msg_MSG');?>
                                </div>
                            <?php } ?>
                            <div id="delete-msg" class="alert alert-success hidden">
                                ...
                                <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                        ...
                                        <tr role="row" class="filter">
                                            <td></td>                                       
                                            <td><input type="text" class="form-control form-filter input-sm" name="feedback_user_search"></td>
                                            <td><input type="text" class="form-control form-filter input-sm" name="feedback_question_search"></td>
                                            <td><input type="text" class="form-control form-filter input-sm" name="feedback_user_ans_search"></td>
