                            ...
                            <div class="table-container">
                                <table class="table table-striped table-bordered table-hover" id="datatable_ajax">
                                        ...
                                        <tr role="row" class="filter">
                                            <td></td>                                       
                                            <td><input type="text" class="form-control form-filter input-sm" name="user_name_search"></td>
                                            <td><input type="text" class="form-control form-filter input-sm" name="user_email_search"></td>
                                            <td><input type="text" class="form-control form-filter input-sm" name="last_login_search" id="last_login_search" readonly></td>
                                            <td><input type="text" class="form-control form-filter input-sm" name="created_date_search" id="created_date_search" readonly></td>
...
jQuery(document).ready(function() {           
    ...
    $('#last_login_search').datepicker({               
            autoclose:true,
            format: 'yyyy-mm-dd'
    });    
    $('#created_date_search').datepicker({               
            autoclose:true,
            format: 'yyyy-mm-dd'
    });    
});
